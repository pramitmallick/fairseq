...
@register_model_architecture('tg', 'tg')
...
@register_model_architecture('tg', 'tg_wiseman_iwslt_de_en')
def tg_wiseman_iwslt_de_en(args):
    args.dropout = getattr(args, 'dropout', 0.1)
...
@register_model_architecture('tg', 'tg_luong_wmt_en_de')
def tg_luong_wmt_en_de(args):
